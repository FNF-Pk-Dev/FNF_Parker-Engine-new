...
class VisualsUISubState extends BaseOptionsMenu
{
	public function new()
	{
		...
		var option:Option = new Option('Note Splashes Opponent', "If unchecked, hitting Opponent notes won't show particles.", 'noteSplashesOpponent', 'bool',
			false);
		addOption(option);
		...
		var option:Option = new Option('Rainbow FPS', 'Rainbow FPS text', 'rainbowFPS', 'bool', false);
		addOption(option);
		...
		var option:Option = new Option('Pause Screen Song:', "What song do you prefer for the Pause Screen?", 'pauseMusic', 'string', 'Snowden Sancturay',
			['None', 'Breakfast', 'Tea Time', 'Peace']);
		addOption(option);
