...
class FunkinLua extends GlobalScript {
	...
	public function new(script:String) {
		...
		*/
		...
		Lua_helper.add_callback(lua, "makeLuaVideoSprite", function(tag:String, ?path:String = null, ?x:Float = 0, ?y:Float = 0, ?destroyOnUse = true) {
			tag = tag.replace('.', '');
		...
		Lua_helper.add_callback(lua, "EndVideo", function(tag:String) {
		    if(PlayState.instance.getLuaVideoObject(tag)!=null){
