...
class MainMenuState extends MusicBeatState
{
	...
	public static var PkEngineVersion:String = '0.6.3';
	...
	override function create()
	{
		...
		var versionShit:FlxText = new FlxText(12, FlxG.height - 64, 0, "Pk Engine v" + PkEngineVersion, 12);
	...
	override function update(elapsed:Float)
	{
		...
		if (!selectedSomethin)
		{
			...
			if (controls.ACCEPT)
			{
				...
				{
					// MusicBeatState.switchState(new HScriptState("Test"));
			...
			#if (desktop || android)
			else if (FlxG.keys.anyJustPressed(debugKeys) #if android || _touchpad.buttonE.justPressed #end)
			{
				selectedSomethin = true;
