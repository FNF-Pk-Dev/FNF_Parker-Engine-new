	...
	public function new(script:String) {
		...
		Lua_helper.add_callback(lua, "keyJustPressed", function(name:String) {
			...
			switch(name) {
				...
				case 'space': key = FlxG.keys.justPressed.SPACE || PlayState.instance.getControl('SPACE_P');//an extra key for convinience
			}
			return key;
		});
		Lua_helper.add_callback(lua, "keyPressed", function(name:String) {
			...
			switch(name) {
				...
				case 'space': key = FlxG.keys.pressed.SPACE || PlayState.instance.getControl('SPACE');//an extra key for convinience
			}
			return key;
		});
		Lua_helper.add_callback(lua, "keyReleased", function(name:String) {
			...
			switch(name) {
				...
				case 'space': key = FlxG.keys.justReleased.SPACE || PlayState.instance.getControl('SPACE_R');//an extra key for convinience
			}
			return key;
		});
