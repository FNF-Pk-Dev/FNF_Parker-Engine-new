...
*/
    ...
    */
	...
	function initScripts()
	{
		...
		var filesAssets:Array<String> = SONG.song == null ? [] : ScriptUtil.findScriptsInDir(Paths.getPreloadPath("data/" + Paths.formatToSongPath(SONG.song)));
		...
		{
			for (_ in ScriptUtil.findScriptsInDir(Paths.getPreloadPath("scripts")))
				filesAssets.push(_);
		}
